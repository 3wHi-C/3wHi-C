...
boundary_file <- paste(args,"3w_call_boundary_left_up.txt",sep = "_")
...
IS_file <- paste("/mnt/disk6/3/3w_manuscript/sub_boundary/method2_call_boundary/ice_is-300Kb-ids-200kb_left_up/",args,"_3w_IS_LU.txt",sep = "")
delta_file <- paste("/mnt/disk6/3/3w_manuscript/sub_boundary/method2_call_boundary/ice_is-300Kb-ids-200kb_left_up/",args,"_3w_delta_LU_gt0.1.txt",sep = "")
final_boundary_file <- paste("/mnt/disk6/3/3w_manuscript/sub_boundary/method2_call_boundary/ice_is-300Kb-ids-200kb_left_up/",args,"_3w_true_boundary_LU_gt0.1.txt",sep = "")
final_boundary_file2 <- paste("/mnt/disk6/3/3w_manuscript/sub_boundary/method2_call_boundary/ice_is-300Kb-ids-200kb_left_up/",args,"_3w_true_boundary_LU.txt",sep = "")
